(function(){
'use strict';
const OFFICIAL_THEME='assets/audio/music/vale-empires-official-theme.mp3';
const MUSIC={
  officialTheme:OFFICIAL_THEME,
  menu:OFFICIAL_THEME,
  exploration:OFFICIAL_THEME,
  combat:OFFICIAL_THEME,
  victory:'assets/audio/music/victory-fanfare.ogg',
  defeat:'assets/audio/music/defeat-lament.ogg',
  legacyMenu:'assets/audio/music/menu-royal.ogg',
  legacyExploration:'assets/audio/music/exploration-fields.ogg',
  legacyCombat:'assets/audio/music/combat-siege.ogg'
};
const SFX={
...
function settingsHTML(){return `<div class="setting-card audio-settings-card"><h3>Áudio e música</h3><p>Tema musical oficial do Vale Empires integrado em MP3, com loop e efeitos preservados.</p><div class="audio-setting-grid">
...
function diagnostics(){return{unlocked,pendingScene,currentKey,combat,ducked,prefs:{...prefs},musicCount:Object.keys(MUSIC).length,officialTheme:OFFICIAL_THEME,sfxCount:Object.keys(SFX).length,stingerCount:Object.keys(STINGERS).length}}
preload();
